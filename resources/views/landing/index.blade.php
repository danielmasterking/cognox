                ...
                <div class="row h-100 align-items-center">
                    ...
                    <div class="col-12 col-md-5">
                        <div class="hero-slides-thumb" data-animation="fadeInUp" data-delay="1000ms">
                            <img src="{{ asset('img/bg-img/bg-2.png') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row align-items-center">
            <div class="col-12 col-md-6">
                <div class="about-thumbnail mb-100">
                    <img src="{{ asset('img/bg-img/about.png') }}" alt="">
                </div>
            </div>
            <div class="col-12 col-md-6">
                ...
                <div class="cryptos-prices-table">
                    ...
                    <div class="single-price-table d-flex align-items-center justify-content-between">
                        <div class="p-content d-flex align-items-center">
                            <span>01</span>
                            <img src="{{ asset('img/bg-img/bitcoin.png') }}" alt="">
                    ...
                    <div class="single-price-table d-flex align-items-center justify-content-between">
                        <div class="p-content d-flex align-items-center">
                            <span>02</span>
                            <img src="{{ asset('img/bg-img/ethereum.png') }}" alt="">
                    ...
                    <div class="single-price-table d-flex align-items-center justify-content-between">
                        <div class="p-content d-flex align-items-center">
                            <span>03</span>
                            <img src="{{ asset('img/bg-img/bitcoin-cash.png') }}" alt="">
                    ...
                    <div class="single-price-table d-flex align-items-center justify-content-between">
                        <div class="p-content d-flex align-items-center">
                            <span>04</span>
                            <img src="{{ asset('img/bg-img/ripple.png') }}" alt="">
                    ...
                    <div class="single-price-table d-flex align-items-center justify-content-between">
                        <div class="p-content d-flex align-items-center">
                            <span>05</span>
                            <img src="{{ asset('img/bg-img/litecoin.png') }}" alt="">
